...
export const EDITORIAL_PLAYLISTS: EditorialPlaylist[] = [
  ...
  },
  {
    id: "worship",
    title: "Worship",
    description: "Música para los momentos más importantes.",
    genreSlugs: ["worship"],
  ...
  },
  {
    id: "commercial",
    title: "Commercial",
    description: "Para marcas que suenan como líderes.",
  ...
  },
  {
    id: "podcast-vibes",
    title: "Podcast Vibes",
    description: "El fondo que hace que tu voz suene mejor.",
    genreSlugs: ["podcast"],
    moodKeywords: ["tranquilo", "concentrado"],
    coverVariant: "teal",
    coverImage: null,
